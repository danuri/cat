...
<div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="<?= site_url()?>" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="<?= base_url()?>xassets/images/logo-dark.png" alt="" height="21">
                    </span>
                </a>
                <!-- Light Logo-->
                <a href="<?= site_url()?>" class="logo logo-light">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <div class="help-box text-center">
                            <img src="<?= base_url()?>xassets/images/create-invoice.png" class="img-fluid" alt="">
    ...
    <script src="<?= base_url()?>xassets/js/plugins.js"></script>
